                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <table>
                            ...
                            <tr class="d-flex gap-4">
                                <td class="fw-medium" style="width: 131px;">Status </td>
                                <td>:
                            ...
                            <tr class="d-flex gap-4">
                                <td class="fw-medium" style="width: 131px;">Waktu Pinjam</td>
                                <td>: {{ $booking->created_at->format('d M Y') }}</td>
                            </tr>
                            <tr class="d-flex gap-4">
                                <td class="fw-medium" style="width: 131px;">Tenggat Kembali</td>
                                <td>: {{ date('d M Y', strtotime($booking->expired_at)) }}</td>
                            </tr>
                            <tr class="d-flex gap-4">
                                <td class="fw-medium" style="width: 131px;">Alasan Pinjam</td>
                    ...
                    <div class="card-body">
                        <table>
                            <tr class="d-flex gap-4">
                                <td class="fw-medium" style="width: 100px;">Judul Buku</td>
                            ...
                            <tr class="d-flex gap-4">
                                <td class="fw-medium" style="width: 100px;">Stock Buku</td>
